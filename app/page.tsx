        ...
        <div className="mx-auto max-w-5xl">
          ...
          <div className="mt-40 grid gap-6 sm:grid-cols-3">
            {[
              ...
              {
                title: "Instant Report Handling",
                description: "Rapid verification and secure forwarding to the right authorities.",
                icon: (
                  <svg
                    className="h-6 w-6 text-sky-400"
                    fill="none"
          ...
          {/* Stats Section */}
          <div className="mt-40 rounded-2xl bg-zinc-900 p-8 shadow-lg">
            <div className="grid gap-y-8 sm:grid-cols-3">
              {[
                { value: "500+", label: "Cities Covered" },
                { value: "98%", label: "Response Success Rate" },
